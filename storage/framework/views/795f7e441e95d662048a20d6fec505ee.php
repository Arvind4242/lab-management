...
<head>
    ...
    <title><?php echo e($report->report_name ?? 'Path24 Labs - Medical Report'); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
            ...
            <tr>
                ...
                <td style="width: 45%;">
                    <div class="contact-info">
                        <div><strong>Main Lab:</strong> <?php echo e(auth()->user()?->address ?? '...'); ?></div>
                        <div><strong>Customer Care:</strong> <?php echo e(auth()->user()?->mobile ?? '...'); ?></div>
                        <div><strong>Reference Lab:</strong> <?php echo e(auth()->user()?->reference_lab ?? '...'); ?></div>
                        <div>In Front of M.Y. Hospital, Gate No. 2, Indore (M.P.)</div>
                        <div><strong>Email:</strong> <?php echo e(auth()->user()?->email ?? '...'); ?></div>
                        <div><strong>Web:</strong> <?php echo e(auth()->user()?->website ?? '...'); ?></div>
                    </div>
                </td>
            </tr>
        </table>
                ...
                <td style="width: 50%;">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="info-value">: <strong><?php echo e(auth()->user()->lab_code ?? '-'); ?></strong></td>
                        </tr>
                        <tr>
                            <td class="info-label">Patient Name</td>
                            <td class="info-value">: <strong><?php echo e(strtoupper($report->patient_name ?? '-')); ?></strong></td>
                        </tr>
                        <tr>
                            <td class="info-label">Age</td>
                            <td class="info-value">: <?php echo e($report->age ?? '-'); ?> / <?php echo e(strtoupper($report->gender ?? '-')); ?></td>
                        </tr>
                        <tr>
                            <td class="info-label">Referred By</td>
                            <td class="info-value">: <strong><?php echo e(strtoupper($report->referred_by ?? 'SELF')); ?></strong></td>
                        </tr>
                        <tr>
                            <td class="info-label">Client Name</td>
                            <td class="info-value">: <strong><?php echo e(strtoupper($report->client_name ?? '-')); ?></strong></td>
                        </tr>
                    </table>
                </td>
                <td style="width: 50%; text-align: right;">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="info-value" style="text-align: right;">: <?php echo e(\Carbon\Carbon::parse($report->collection_date ?? '')->format('d/m/Y h:i A')); ?></td>
                        </tr>
                        <tr>
                            <td class="info-label" style="text-align: right;">Reported At</td>
                            <td class="info-value" style="text-align: right;">: <?php echo e(\Carbon\Carbon::parse($report->reporting_date ?? '')->format('d/m/Y h:i A')); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <!-- Lab Name Title -->
        <div class="title">
            <?php echo e(optional(\App\Models\Lab::find(auth()->user()?->lab_id))->name ?? 'Authorized Signatory'); ?>

        </div>

        <!-- Section Title -->
        <?php if($report->results->isNotEmpty()): ?>
            <?php
            ...
            <div class="section-title">
                <?php if(!empty($panelName)): ?>
                    <?php echo e($panelName); ?>

                <?php elseif(!empty($testName)): ?>
                    <?php echo e($testName); ?>
...
<table class="results-table">
    ...
    <tbody>
        ...
        <?php if($interpretations->isNotEmpty()): ?>
            <tr>
                <td colspan="4">
                    <div class="interpretation-section">
                        <?php $__currentLoopData = $interpretations->unique('test_group'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupTest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!empty($groupTest->interpretation)): ?>
                                <strong><?php echo e(strtoupper($groupTest->test_group)); ?> - Interpretation:</strong>
                                <p><?php echo e($groupTest->interpretation); ?></p>
                            <?php endif; ?>
    ...
    <tr>
      ...
      <td style="width: 70%;">
        <div class="signature-section">
          <?php if(auth()->user()->digital_signature): ?>
              <?php
              ...
              <?php if($signatureBase64): ?>
                  <img src="<?php echo e($signatureBase64); ?>" alt="Signature">
              <?php endif; ?>
          <?php endif; ?>
          <div class="doctor-name"><?php echo e(auth()->user()?->name ?? 'Authorized Signatory'); ?></div>
          <div class="designation"><?php echo e(auth()->user()?->qualification ?? 'Medical Director'); ?></div>
        </div>
      </td>
    </tr>
  </table>

  <?php if(auth()->user()?->note): ?>
      <div class="note-footer" style="font-size: 14px;">
          <strong>Note:</strong> <?php echo e(auth()->user()->note); ?>
...
<?php /**PATH C:\xampp\htdocs\laravel\resources\views/reports/print.blade.php ENDPATH**/ ?>