...
<?php $component->withAttributes([]); ?>
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-lg font-semibold"><?php echo e($user->name); ?></h2>
...
<?php $component->withAttributes([]); ?>
            ...
            <div class="text-sm space-y-2">
                ...
                <div><strong>Website:</strong> <?php echo e($user->website ?? '—'); ?></div>
                <div><strong>Address:</strong> <?php echo e($user->address ?? '—'); ?></div>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9b945b32438afb742355861768089b04)): ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <div class="grid grid-cols-2 gap-4 text-sm">
                <div><strong>Lab:</strong> <?php echo e($user->lab?->name ?? '—'); ?></div>
                <div><strong>Lab Code:</strong> <?php echo e($user->lab_code ?? '—'); ?></div>
                <div><strong>Qualification:</strong> <?php echo e($user->qualification ?? '—'); ?></div>
                <div><strong>Reference Lab:</strong> <?php echo e($user->reference_lab ?? '—'); ?></div>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9b945b32438afb742355861768089b04)): ?>
...
<?php $component->withAttributes([]); ?>
            <div class="flex justify-end gap-3">
                <a href="<?php echo e(\App\Filament\Admin\Resources\UserResource::getUrl('edit', ['record' => $user])); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel\resources\views/filament/admin/pages/user-profile.blade.php ENDPATH**/ ?>