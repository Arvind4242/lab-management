...
<?php foreach($attributes->onlyProps(['field','hasInlineLabel']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['field','hasInlineLabel']); ?>
<?php foreach (array_filter((['field','hasInlineLabel']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-forms::components.field-wrapper.index','data' => ['field' => $field,'hasInlineLabel' => $hasInlineLabel]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\storage\framework\views/f48d4e11b9e3a24dd3a2cb9546765aee.blade.php ENDPATH**/ ?>