...
<div class="container my-4">
    <div class="report-container">
        ...
        <form action="<?php echo e(route('reports.update', $report->id)); ?>" method="POST" id="reportForm">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="patient_name" class="form-control form-control-lg"
                                   placeholder="Enter patient name" value="<?php echo e($report->patient_name); ?>" required>
                        </div>
                        <div class="col-md-2">
                            ...
                            <input type="number" name="age" class="form-control form-control-lg"
                                   placeholder="Age" value="<?php echo e($report->age); ?>" required>
                        </div>
                        <div class="col-md-2">
                            <label class="form-label fw-semibold">Gender <span class="text-danger">*</span></label>
                            <select name="gender" class="form-select form-select-lg" required>
                                <option value="">Select</option>
                                <option value="Male" <?php echo e($report->gender === 'Male' ? 'selected' : ''); ?>>Male</option>
                                <option value="Female" <?php echo e($report->gender === 'Female' ? 'selected' : ''); ?>>Female</option>
                                <option value="Other" <?php echo e($report->gender === 'Other' ? 'selected' : ''); ?>>Other</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Referred By</label>
                            <input type="text" name="referred_by" class="form-control form-control-lg"
                                   placeholder="Doctor's name" value="<?php echo e($report->referred_by); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Client Name</label>
                            <input type="text" name="client_name" class="form-control form-control-lg"
                                   placeholder="Client name" value="<?php echo e($report->client_name); ?>">
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="date" name="test_date" class="form-control form-control-lg"
                                   value="<?php echo e($report->test_date->format('Y-m-d')); ?>" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="panel_selector" class="form-select form-select-lg">
                            ...
                            <?php $__currentLoopData = $panels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="panel_<?php echo e($id); ?>"
                                        data-category-id="<?php echo e($panelCategories[$id] ?? ''); ?>"
                                        <?php echo e($report->test_panel_id == $id ? 'selected' : ''); ?>>
                                    <?php echo e($name); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="test_selector" class="form-select form-select-lg" multiple>
                            <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="test_<?php echo e($test->id); ?>"
                                        data-category-id="<?php echo e($test->category_id ?? ''); ?>">
                    ...
                    <input type="hidden" name="test_panel_id" id="test_panel_id" value="<?php echo e($report->test_panel_id); ?>">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody id="test-list">
                                <?php $__currentLoopData = $report->report_results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr data-test-id="<?php echo e($result->report_test_id); ?>">
                                        <td class="fw-semibold">
                                            <i class="bi bi-clipboard-pulse text-primary me-2"></i><?php echo e($result->test_name); ?>

                                            <input type="hidden" name="tests[<?php echo e($index); ?>][test_id]" value="<?php echo e($result->report_test_id); ?>">
                                            <input type="hidden" name="tests[<?php echo e($index); ?>][test_name]" value="<?php echo e($result->test_name); ?>">
                                            <input type="hidden" name="tests[<?php echo e($index); ?>][unit]" value="<?php echo e($result->unit); ?>">
                                            <input type="hidden" name="tests[<?php echo e($index); ?>][reference_range]"
                                                value="<?php echo e($result->reference_range); ?>"
                                                data-male="<?php echo e($result->test->reference_range_male ?? ''); ?>"
                                                data-female="<?php echo e($result->test->reference_range_female ?? ''); ?>"
                                                data-other="<?php echo e($result->test->reference_range_other ?? ''); ?>">
                                        </td>
                                        <td>
                                            <input type="text" name="tests[<?php echo e($index); ?>][value]"
                                                   class="form-control result-input"
                                                   placeholder="Enter result"
                                                   value="<?php echo e($result->value); ?>">
                                        </td>
                                        <td class="text-muted"><?php echo e($result->unit); ?></td>
                                        <td class="ref-range"><span class="badge bg-secondary"><?php echo e($result->reference_range); ?></span></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\resources\views/reports/edit.blade.php ENDPATH**/ ?>